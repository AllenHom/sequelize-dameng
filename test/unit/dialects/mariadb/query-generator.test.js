    ...
    const suites = {
      ...
      createSchema: [
        ...
        },
        {
          ...
          expectation:
            "CREATE SCHEMA IF NOT EXISTS `mySchema` DEFAULT CHARACTER SET 'utf8mb4' DEFAULT COLLATE 'utf8mb4_unicode_ci';"
        }
      ],
      dropSchema: [
        {
      ...
      showSchemasQuery: [
        {
          arguments: [{}],
          expectation:
            "SELECT SCHEMA_NAME as schema_name FROM INFORMATION_SCHEMA.SCHEMATA WHERE SCHEMA_NAME NOT IN ('MYSQL', 'INFORMATION_SCHEMA', 'PERFORMANCE_SCHEMA');"
        },
        {
          arguments: [{ skip: [] }],
          expectation:
        ...
        },
        {
          arguments: [{ skip: ['test'] }],
          expectation:
            "SELECT SCHEMA_NAME as schema_name FROM INFORMATION_SCHEMA.SCHEMATA WHERE SCHEMA_NAME NOT IN ('MYSQL', 'INFORMATION_SCHEMA', 'PERFORMANCE_SCHEMA', 'test');"
        },
        {
          arguments: [{ skip: ['test', "Te'st2"] }],
          expectation:
            "SELECT SCHEMA_NAME as schema_name FROM INFORMATION_SCHEMA.SCHEMATA WHERE SCHEMA_NAME NOT IN ('MYSQL', 'INFORMATION_SCHEMA', 'PERFORMANCE_SCHEMA', 'test', 'Te\\'st2');"
        }
      ],
      arithmeticQuery: [
        {
      ...
      attributesToSQL: [
        ...
        },
        {
          arguments: [
            {
              id: { type: 'INTEGER', references: { model: 'Bar', key: 'pk' } }
            }
          ],
          ...
          arguments: [
            {
              id: {
                type: 'INTEGER',
                references: { model: 'Bar' },
                onDelete: 'CASCADE'
              }
            }
          ],
          expectation: {
            id: 'INTEGER REFERENCES `Bar` (`id`) ON DELETE CASCADE'
          }
        },
        {
          arguments: [
      ...
      createTableQuery: [
        ...
        },
        {
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`title` VARCHAR(255), `name` VARCHAR(255)) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_unicode_ci;'
        },
        {
        ...
        },
        {
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`title` VARCHAR(255), `name` VARCHAR(255)) ENGINE=InnoDB ROW_FORMAT=default;'
        },
        {
          arguments: [
            'myTable',
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`title` VARCHAR(255), `name` VARCHAR(255), `id` INTEGER , PRIMARY KEY (`id`)) ENGINE=InnoDB;'
        },
        {
          arguments: [
            'myTable',
        ...
        },
        {
          arguments: [
            'myTable',
            { title: 'VARCHAR(255)', name: 'VARCHAR(255)' },
            { uniqueKeys: [{ fields: ['title', 'name'], customIndex: true }] }
          ],
          expectation:
        ...
        },
        {
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`id` INTEGER auto_increment , PRIMARY KEY (`id`)) ENGINE=InnoDB AUTO_INCREMENT=1000001;'
        }
      ],
      ...
      selectQuery: [
        ...
        },
        {
          ...
          expectation:
            "SELECT * FROM `myTable` ORDER BY f1(`myTable`.`id`) DESC, f2(12, 'lalala', '2011-03-27 10:01:55.000') ASC;",
          context: QueryGenerator,
          needsSequelize: true
        },
        {
          ...
          arguments: [
            ...
            function (sequelize) {
              return {
                where: sequelize.and(sequelize.where(sequelize.fn('LOWER', sequelize.col('user.name')), 'jan'), {
                  type: 1
                })
              };
            }
        ...
        },
        {
              ...
              return {
                where: sequelize.and(
                  ...
                  sequelize.where(
                    sequelize.fn(
                      'COALESCE',
                      sequelize.col('place_type_codename'),
                      sequelize.col('announcement_type_codename')
                    ),
                    { [Op.in]: ['Lost', 'Found'] }
                  )
                )
          ...
          expectation:
            "SELECT * FROM `myTable` WHERE (`myTable`.`archived` IS NULL AND COALESCE(`place_type_codename`, `announcement_type_codename`) IN ('Lost', 'Found'));",
          context: QueryGenerator,
          needsSequelize: true
        },
        {
      ...
      insertQuery: [
        ...
        },
        {
          arguments: [
            ...
            {
              name: 'foo',
              birthday: new Date(Date.UTC(2011, 2, 27, 10, 1, 55))
            }
          ],
          expectation: {
        ...
        },
        {
          arguments: [
            ...
            [
              ...
              {
                name: 'bar',
                birthday: new Date(Date.UTC(2012, 2, 27, 10, 1, 55))
              }
            ]
          ],
          expectation:
