      ...
      createTableQuery: [
        ...
        },
        {
          arguments: [
            'myTable',
            {
              title: 'VARCHAR BINARY(255)',
              number: 'INTEGER(5) UNSIGNED PRIMARY KEY '
            }
        ...
        },
        {
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS `myTable` (`title` VARCHAR(255), `name` VARCHAR(255), `id` INTEGER PRIMARY KEY);'
        },
        {
          arguments: [
            'myTable',
        ...
        },
        {
          arguments: [
            'myTable',
            {
              id: 'SMALLINT(4) PRIMARY KEY AUTOINCREMENT UNSIGNED',
              name: 'VARCHAR(255)'
            }
          ],
          expectation:
        ...
        },
        {
          arguments: [
            'myTable',
            {
              foo1: 'INTEGER PRIMARY KEY NOT NULL',
              foo2: 'INTEGER PRIMARY KEY NOT NULL'
            }
          ],
          expectation:
      ...
      insertQuery: [
        ...
        },
        {
          arguments: [
            ...
            {
              name: 'foo',
              birthday: moment('2011-03-27 10:01:55 +0000', 'YYYY-MM-DD HH:mm:ss Z').toDate()
            }
          ],
          expectation: {
        ...
        },
        {
          arguments: [
            ...
            [
              ...
              {
                name: 'bar',
                birthday: moment('2012-03-27 10:01:55 +0000', 'YYYY-MM-DD HH:mm:ss Z').toDate()
              }
            ]
          ],
          expectation:
