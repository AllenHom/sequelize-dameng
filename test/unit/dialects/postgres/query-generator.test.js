    ...
    const suites = {
        ...
        },
        {
          arguments: [
            ...
            },
            {
              context: 'addColumn',
              key: 'column',
              table: { schema: 'foo', tableName: 'bar' }
            }
          ],
          expectation: {
      ...
      createTableQuery: [
        ...
        },
        {
          arguments: [
            'myTable',
            {
              ...
              bigserial: 'BIGINT SERIAL',
              smallserial: 'SMALLINT SERIAL'
            }
          ],
          expectation:
        ...
        },
        {
          ...
          expectation:
            'CREATE TABLE IF NOT EXISTS "myTable" ("int" INTEGER , "foo" INTEGER ); COMMENT ON COLUMN "myTable"."int" IS \'Test\'; COMMENT ON COLUMN "myTable"."foo" IS \'Foo Comment\';'
        },
        {
