...
class QueryInterface {
  ...
  async createDatabase(database, options) {
    ...
    return await this.sequelize.query(sql.toLowerCase(), options);
  }
  ...
  async dropTable(tableName, options) {
    ...
    await this.sequelize.query(sql.toLowerCase(), options);
  }
  ...
  async describeTable(tableName, options) {
    ...
    try {
      const data = await this.sequelize.query(sql.toLowerCase(), options);
      /*
  ...
  async changeColumn(tableName, attributeName, dataTypeOrOptions, options) {
    ...
    return this.sequelize.query(sql.toLowerCase(), options);
  }
  ...
  async addIndex(tableName, attributes, options, rawTablename) {
    ...
    return await this.sequelize.query(sql.toLowerCase(), { ...options, supportsSearchPath: false });
  }
  ...
  async showIndex(tableName, options) {
    ...
    return await this.sequelize.query(sql.toLowerCase(), { ...options, type: QueryTypes.SHOWINDEXES });
  }
  ...
  async showConstraint(tableName, constraintName, options) {
    ...
    return await this.sequelize.query(sql.toLowerCase(), { ...options, type: QueryTypes.SHOWCONSTRAINTS });
  }
  ...
  async insert(instance, tableName, values, options) {
    ...
    const results = await this.sequelize.query(sql.toLowerCase(), options);
  ...
  async commitTransaction(transaction, options) {
    ...
    const promise = this.sequelize.query(sql.toLowerCase(), options);
